...
avg_loan_amt = (sum_of_loans)/(number_of_loans)
print(f'The AVERAGE LOAN AMT for this portfolio is {avg_loan_amt}')
...
print(f'The FUTURE VALUE of this loan is: {future_val}')

remaining_months = loan.get("remaining_months")
print(f'The REMAINING MONTHS to maturity is: {remaining_months}')
...
if present_value >= loan_price:
    print("THIS IS A GOOD DEAL BUY THIS LOAN!")
else:
...
def calc_present_val (future_value,remaining_months,annual_discount_rate):
    present_val = (future_value) / (1 + annual_discount_rate/12) ** remaining_months
    return present_val
...
for note in loans:
    if note["loan_price"] <=500:
        inexpensive_loans.append(note)
